package com.amigo.ai.rxjavatest.plugin;
...
import com.amigo.ai.rxjavatest.plugin.ams.AMSHookHelper;
...
//        getSystemService(Context.ACTIVITY_SERVICE);
        ...
        findViewById(R.id.test_iv).setOnClickListener(new View.OnClickListener() {
            @Override
